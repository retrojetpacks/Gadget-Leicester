...
#ifdef REAL_EOS
//double kappa1[2850],kappa2[81][1251];                /*!< SHC */
//double kappa_P[1100],kappa_R[1000];                /*!< SHC */
#endif
...
int FirstSinkParticle;
int *NextSinkParticle;
#endif

#ifdef VIRTUAL
int FirstPhoton;
int *NextPhoton;
int FirstActivePhoton;
int *NextActivePhoton;
#endif
...
FILE *diag_shc,*diag_shc_ene,*diag_shc_photon,*diag_shc_photon_total;         /*!< SHC */
#ifdef REAL_EOS
FILE *data_kappa;                /*!< SHC */
#endif
FILE *photonSN;         /*!< SN */
...
/* structures for eddington tensor data in and out*/
#ifdef RADTRANSFER
struct eddingtondata_in *EddingtonDataIn, *EddingtonDataGet;
struct eddingtondata_out *EddingtonDataResult, *EddingtonDataOut;
#endif
